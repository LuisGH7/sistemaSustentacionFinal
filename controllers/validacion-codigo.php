...
if (isset($_GET['op'])){
  ...
  if($operacion == 'enviarEmail'){
    try{
        ...
        $mail->Body    = 'Estimado/a '. $datospersona.', para recuperar su contraseña ingrese el siguiente codigo de verificación: </br> <h1 style="text-align:center">'.  $codigo . '</h1>' ;
        $mail->AltBody = 'Proyecto de Ing. Software con I.A./Grupo Technology - SENATI';
        // $mail->addAttachement('../images/correo.png');
