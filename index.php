			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="flex-sb-m w-full p-t-3 mb-3">
						<div></div>
						<div>
							<a href="#" type="button"style="color:#545454" id="recuperaracceso" data-toggle="modal" data-target="#modelId" class="text1">¿Olvidaste tu contraseña?</a>
						</div>
					</div>

					<div class="container-login100-form-btn">
						<a type="button" class="login100-form-btn" style="color:white" id="login">Login</a>
					</div>
                    ...
                    <form action="" id="modificar-persona">
						...
						<div class="input-group">
							...
							<div class="input-group-append">
								<div type="button" class="btn"  id="verificarCorreo" style="background-color:#548cbe; color: white">Enviar</div>
							</div>
						</div>
						<br>
                        <div id="cajavalidacioncodigo" style="display: none;">
							...
							<div class="input-group">
								...
								<button type="button" id="validar" class="btn-block btn btn-md mt-3" style="background-color:#548cbe; color: white">Validar</button>
							<br>
						</div>
					</form>
                </div>
...
<script>	
	$(document).ready(function(){
		...
		// $("#caja6").keyup(function (){ $("#validar").focus(); });
		// 48 a 57 // 65 a 70
			...
			if ($("#usuario").val() == "" || $("#clave").val() == ""){
				...
				$.ajax({
					...
					success: function (result){
						console.log(result);
						if ($.trim(result) == "1"){
							window.location.href = 'main.php?view=productividad-medicos'
						}if($.trim(result) == "2"){
							window.location.href = 'main.php?view=procesoprincipal'
						}if($.trim(result) == "3"){
							window.location.href = 'main.php?view=especialidadesprocesos'
						}if($.trim(result) == "4"){
