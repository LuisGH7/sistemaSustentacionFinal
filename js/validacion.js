            ...
            $.ajax({
                ...
                success: function(e){
                    if(e == 2){
                        ...
                        cronometro();
                        // Para ocultar las cajas de texto del código de verificación
                        setTimeout(function(){
                          cajaValidacion.setAttribute("style", "display: none;");
                          mostrarAlerta('warning' ,'Vuelva a crear un código.');
                        }, 300000);
                    }else{
      ...
      $.ajax({
        ...
        success: function(result){
          ...
          if(codigoenviado == codigorecibido){
            ...
            mostrarAlerta('warning' ,'Vuelva a escribir el codigo');
          }
        }
      });
